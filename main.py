...
class HelloWorld(toga.App):
    def startup(self):
        ...
        # Suwak
        self.slider = toga.Slider(range=(0, 100), default=50, style=Pack(padding=5))

        # Pole wyboru (checkbox)
        self.checkbox = toga.Switch('Toggle me!', style=Pack(padding=5))
    ...
    def button_handler(self, widget):
        ...
        print(f"Checkbox state: {'On' if self.checkbox.is_on else 'Off'}")
